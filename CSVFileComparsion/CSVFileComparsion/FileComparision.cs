...
namespace CSVFileComparsion
{
    public class FileComparision
    {
        static void Main(string[] args)
        {
            ...
            string csvfilePathOne = ConfigurationManager.AppSettings["Path"]+ "\\TestFiles\\SalesRecords-1.csv";
            string csvfilePathTwo = ConfigurationManager.AppSettings["Path"]+ "\\TestFiles\\SalesRecords-2.csv";
            string resultfilePath = ConfigurationManager.AppSettings["Path"]+ "\\ErrorResult\\";
